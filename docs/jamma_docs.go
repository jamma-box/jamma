...
// SwaggerInfojamma holds exported Swagger Info so clients can modify it
var SwaggerInfojamma = &swag.Spec{
	Version:          "1.0 版本",
	Host:             "",
	BasePath:         "/api/",
	Schemes:          []string{},
	Title:            "jamma接口文档",
	Description:      "API文档",
	InfoInstanceName: "jamma",
	SwaggerTemplate:  docTemplatejamma,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfojamma.InstanceName(), SwaggerInfojamma)
}
